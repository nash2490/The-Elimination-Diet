...
static NSString *edDateCellID = @"DateCell";     // the cells with the start or end date
static NSString *edDatePickerID = @"DatePicker"; // the cell containing the date picker

static NSString *edValueCellID = @"ValueCell";
static NSString *edValuePickerCellID = @"ValuePickerCell";

static NSString *edTagCellID = @"TagCell";
static NSString *edImageAndNameCellID = @"ImageAndNameCell";
static NSString *edRestaurantCellID = @"RestaurantCell";
static NSString *edAddMealsAndIngredientsCellID = @"AddMealsAndIngredientsCell";
static NSString *edDetailMealsAndIngredientsCellID = @"DetailMealsAndIngredientsCell";

static NSString *edAddMedsAndIngredientsCellID = @"AddMedsAndIngredientsCell";
static NSString *edDetailMedsAndIngredientsCellID = @"DetailMedsAndIngredientsCell";

static NSString *edAddObjectsCellID = @"AddObjectsCell";
static NSString *edDetailObjectsCellID = @"DetailedObjectsCellID";

static NSString *edLargeImageCellID = @"LargeImageCell";
static NSString *edImageButtonCellID = @"ImageButtonCell";

static NSString *edShowHideCellID = @"ShowHideCell";


static NSString *edMealAndMedicationSegmentedControlCellID = @"MealAndMedicationSegmentedControlCell";

static NSString *edReminderCellID = @"ReminderCell";

static NSString *edDetailMealMedCellID = @"DetailMealMedCell";
...
@property (nonatomic, weak) iCarousel *edCarousel;
